...
public class MyGroupsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (myGroupsView instanceof RecyclerView) {
            ((RecyclerView)myGroupsView).setAdapter(new MyGroupsRecyclerViewAdapter(getActivity(), SessionManagementUtil.getProfileId(), getFragmentManager()));
        }
        return myGroupsView;
    }
