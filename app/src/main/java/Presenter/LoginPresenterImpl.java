    ...
    public class LoginPresenterImpl  implements LoginContract.Presenter
    {
        ...
        public void saveProfileToSessionPreference(Profile profile) {
            SessionManagementUtil.createLoginSession(profile.getProfileId(),profile.getProfileName(), profile.getProfileEmail(),profile.getProfileStory(),profile.getProfileWork());
        }
